(() => {
  ...
  // index.js
  var import_Shiny5 = __toESM(require_Shiny(), 1);
  ...
  function svelteShinyOutput(selector2, outputName2, component2, target2, props, hydrate2) {
    ...
    Shiny.outputBindings.register(SvelteOutputBinding, outputName2);
  }
  ...
  function init(component2, options, instance3, create_fragment3, not_equal, props, append_styles = null, dirty = [-1]) {
    ...
    let ready = false;
    $$.ctx = instance3 ? instance3(component2, options.props || {}, (i, ret, ...rest) => {
  ...
  var import_Shiny3 = __toESM(require_Shiny());
  ...
  function create_each_block(ctx) {
    ...
    return {
      ...
      m(target2, anchor) {
        insert_hydration(target2, li, anchor);
        append_hydration(li, t);
      },
      p(ctx2, dirty) {
        if (dirty & /*shinyOutputValue*/
  ...
  function create_fragment2(ctx) {
    ...
    return {
      ...
      h() {
        ...
        attr(ul, "class", "svelte-list");
      },
      m(target2, anchor) {
        insert_hydration(target2, ul, anchor);
        for (let i = 0; i < each_blocks.length; i += 1) {
          if (each_blocks[i]) {
  ...
  function instance2($$self, $$props, $$invalidate) {
    let { id } = $$props;
    let { shinyOutputValue = ["Item 1", "Item 2"] } = $$props;
    $$self.$$set = ($$props2) => {
      if ("id" in $$props2)
        $$invalidate(0, id = $$props2.id);
      if ("shinyOutputValue" in $$props2)
        $$invalidate(1, shinyOutputValue = $$props2.shinyOutputValue);
    };
    return [id, shinyOutputValue];
  }
  var List = class extends SvelteComponent {
    constructor(options) {
      super();
      init(this, options, instance2, create_fragment2, safe_not_equal, { id: 0, shinyOutputValue: 1 });
    }
    get id() {
      return this.$$.ctx[0];
    }
    ...
    get shinyOutputValue() {
      return this.$$.ctx[1];
    }
    set shinyOutputValue(shinyOutputValue) {
      this.$$set({ shinyOutputValue });
      flush();
    }
  };
